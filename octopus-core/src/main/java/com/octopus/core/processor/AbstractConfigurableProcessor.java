 ...
 */
@Slf4j
abstract class AbstractConfigurableProcessor implements Processor {
    protected Result<Map<String, Object>> processExtractor(String content, Response response, ExtractorProperties extractor) {
