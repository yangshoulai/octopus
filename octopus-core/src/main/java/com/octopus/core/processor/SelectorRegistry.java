...
public class SelectorRegistry {
    private final Map<com.octopus.core.processor.annotation.Selector.Type, Selector> handlers = new HashMap<>();

    private SelectorRegistry() {
        registerHandler(com.octopus.core.processor.annotation.Selector.Type.Url, new UrlSelector());
        registerHandler(com.octopus.core.processor.annotation.Selector.Type.Attr, new AttrSelector());
        registerHandler(com.octopus.core.processor.annotation.Selector.Type.Param, new ParamSelector());
        registerHandler(com.octopus.core.processor.annotation.Selector.Type.Header, new HeaderSelector());
        registerHandler(com.octopus.core.processor.annotation.Selector.Type.Json, new JsonSelector());
        registerHandler(com.octopus.core.processor.annotation.Selector.Type.Css, new CssSelector());
        registerHandler(com.octopus.core.processor.annotation.Selector.Type.Xpath, new XpathSelector());
        registerHandler(com.octopus.core.processor.annotation.Selector.Type.Regex, new RegexSelector());
        registerHandler(com.octopus.core.processor.annotation.Selector.Type.Body, new BodySelector());
        registerHandler(com.octopus.core.processor.annotation.Selector.Type.Value, new ValueSelector());
        registerHandler(com.octopus.core.processor.annotation.Selector.Type.None, new NoneSelector());
    }
    ...
    public Selector getSelectorHandler(@NonNull com.octopus.core.processor.annotation.Selector.Type type) throws SelectorNotFoundException {
    ...
    public void registerHandler(@NonNull com.octopus.core.processor.annotation.Selector.Type type, @NonNull Selector selector) {
    ...
    public List<String> select(com.octopus.core.processor.annotation.Selector selector, String source, boolean multi, Response response) {
    ...
    @NotNull
    private static FormatterProperties getFormatterProperties(com.octopus.core.processor.annotation.Selector selector) {
