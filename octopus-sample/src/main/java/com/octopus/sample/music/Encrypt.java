...
public class Encrypt {
  ...
  public static String rasPublicKeyEncrypt(String content) {
    ...
    String rsaExponent = "010001";
    String rsaModules =
        "";
    return biText
        .modPow(
            new BigInteger(1, HexUtil.decodeHex(rsaExponent)),
            new BigInteger(1, HexUtil.decodeHex(rsaModules)))
        .toString(16);
  }

  public static Map<String, String> getEncryptParams(Map<String, Object> params) {
    String secKey = createAesEncryptKey(16);
    String aesKey = "0CoJUm6Qyw8W8jud";
    String encText = aesEncrypt(aesEncrypt(JSONUtil.toJsonStr(params), aesKey), secKey);
